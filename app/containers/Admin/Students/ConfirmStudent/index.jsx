...
import {
    downloadFile,
    onChange,
    onCloseDialog, onConfirmStudent,
    onOpenDialog, onRefuseStudent,
    reset,
...
const key = "studentListingConfirm";
                    ...
                    confirm={<>
                        <div style={{display: 'flex'}}>
                            <Tooltip title="Xác nhận">
                                <IconButton aria-label="confirm" onClick={props.onConfirmStudent}>
                                    <CheckCircleIcon/>
                                </IconButton>
                            </Tooltip>
                            <Tooltip title="Từ chối">
                                <IconButton aria-label="delete" onClick={props.onRefuseStudent}>
                                    <HighlightOffIcon/>
                                </IconButton>
                            </Tooltip>
                        </div>
...
export function mapDispatchToProps(dispatch) {
    return {
        ...
        onConfirmStudent: (params) => dispatch(onConfirmStudent(params)),
        onRefuseStudent: (params) => dispatch(onRefuseStudent(params))
    };
}
